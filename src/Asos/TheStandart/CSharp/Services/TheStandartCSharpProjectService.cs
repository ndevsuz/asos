...
{
    public class TheStandartCSharpProjectService
    {
        ...
        public TheStandartCSharpProjectService(
            string projectName,
            ...
            string sourcePath)
        {
            ...
            apiProjectName = $"{projectName}.Api";
            testProjectName = $"{apiProjectName}.Tests.Unit";
            buildProjectName = $"{projectName}.Infrastructure.Build";
        ...
        public (string ProjectPath, string ApiProjectPath, string TestProjectPath, string BuildProjectPath) CreateProjectStructure()
        {
            ...
            apiProjectPath = Path.Combine(projectFolderPath, apiProjectName);
            testProjectPath = Path.Combine(projectFolderPath, testProjectName);
            buildProjectPath = Path.Combine(projectFolderPath, buildProjectName);
        ...
        public void ConfigureProject()
        {
            ...
            foreach (var model in modelsPath)
            {
                ...
                usings += model == modelsPath.Last() ? $"using {projectName}.Api.Services.Foundations.{modelNamePlural};" : $"using {projectName}.Api.Services.Foundations.{modelNamePlural};\n";
        ...
        internal void WriteTests()
        {
            ...
            Process.ExecuteCommand($"dotnet add {testProjectPath}/{testProjectName}.csproj reference {apiProjectPath}/{apiProjectName}.csproj");
            ...
            foreach (var modelPath in modelsPath)
            {
                ...
                var modelTestsPath = Path.Combine(testProjectPath, StringConstants.Services, StringConstants.Foundations, modelNamePlural);
